...
class Handler(BaseHTTPRequestHandler):
    def _send(self, code, body, ctype="application/json"):
        ...
        # The React admin is served from another origin (Vite dev server or
        # Cloudflare Pages), so it needs CORS to drive the machine. The agent
        # only listens on the shelf's own LAN, so this stays local.
